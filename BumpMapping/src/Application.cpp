...
void Application::initTexture()
{
	...
	unsigned char* img = SOIL_load_image("normal.jpg", &img_width, &img_height, &channels, 0);
...
void Application::initTexture2()
{
	...
	unsigned char* img = SOIL_load_image("color.jpg", &img_width, &img_height, &channels, 0);  //cambia a skeletorcitos
...
void Application::setup()
{
	...
	PlanoPlox.uTexture[0] = glGetUniformLocation(PlanoPlox.shader[0], "normal");
	...
	PlanoPlox.uTexture2[1] = glGetUniformLocation(PlanoPlox.shader[1], "theTexture");
